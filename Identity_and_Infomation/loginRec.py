...
def recommend_resumes(resumes_data_path, work_id, all_info_path, city_location_path):
    ...
    for resume_id in sorted_scores:
        all_scores.append({
            "resume_id": resume_id,
            "weighted_score": scores[resume_id[0]],
            "skill_score": skill_scores[resume_id[0]],
            "education_score": edu_scores[resume_id[0]],
            "salary_score": salary_scores[resume_id[0]],
            "city_score": city_scores[resume_id[0]]
        })
